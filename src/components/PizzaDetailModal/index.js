...
function PizzaDetailModal({ pizza, isOpen, onClose }) {
      ...
      <div className="bg-white rounded-lg shadow-xl z-10 max-w-2xl w-full relative">
        ...
        <div className="flex flex-col md:flex-row p-4">
          ...
          <div className="md:w-3/5 pl-5 pt-3 pr-2 pb-4">
            <h2 className="text-2xl font-bold text-[#0078ae] mb-4">{pizza.name}</h2>
            <p className="text-xs text-gray-500 mb-4 font-bold">{pizza.description}</p>
            ...
            <div className="space-y-4">
                  ...
                  {pizza.prices?.small && (
                    <div className='border-b pb-2'>
                      <label>
                        ...
                        <span className='p-4'> Cỡ Nhỏ = {pizza.prices.small.toLocaleString()}đ </span>
                      </label>
                    </div>
                  )}
                  {pizza.prices?.medium && (
                    <div className='border-b pb-2'>
                      <label>
                        ...
                        <span className='p-4'>Cỡ Vừa = {pizza.prices.medium.toLocaleString()}đ</span> 
                      </label>
                    </div>
                  )}
                  {pizza.prices?.big && (
                    <div className='border-b pb-2'>
                      <label>
                        ...
                        <span className='p-4'>Cỡ To = {pizza.prices.big.toLocaleString()}đ </span>
                      </label>
                    </div>
                  )}
                </div>
              ...
              <div className="flex items-center justify-start gap-4">
                ...
                <button
                  className="bg-orange-500 text-xs font-bold text-white px-4 h-8 rounded hover:bg-blue-600 flex-shrink-0 "
